...
class Contract extends Base_js_1.Base {
    constructor(api, abi, address, decorateMethod) {
        ...
        _Contract_exec.set(this, (messageOrId, { gasLimit = util_1.BN_ZERO, storageDepositLimit = null, value = util_1.BN_ZERO }, params) => {
        ...
        _Contract_read.set(this, (messageOrId, { gasLimit = util_1.BN_ZERO, storageDepositLimit = null, value = util_1.BN_ZERO }, params) => {
            ...
            return {
                ...
                // @ts-ignore jiggle v1 weights, metadata points to latest
                this._isWeightV1
                    ? tslib_1.__classPrivateFieldGet(this, _Contract_getGas, "f").call(this, gasLimit, true).v1Weight
                    : tslib_1.__classPrivateFieldGet(this, _Contract_getGas, "f").call(this, gasLimit, true).v2Weight, storageDepositLimit, message.toU8a(params)).pipe((0, rxjs_1.map)(({ debugMessage, gasConsumed, gasRequired, result, storageDeposit }) => ({
                    debugMessage,
                    gasConsumed,
        ...
        this.abi.messages.forEach((m) => {
            if ((0, util_1.isUndefined)(tslib_1.__classPrivateFieldGet(this, _Contract_tx, "f")[m.method])) {
                tslib_1.__classPrivateFieldGet(this, _Contract_tx, "f")[m.method] = createTx(m, (o, p) => tslib_1.__classPrivateFieldGet(this, _Contract_exec, "f").call(this, m, o, p));
            }
            if ((0, util_1.isUndefined)(tslib_1.__classPrivateFieldGet(this, _Contract_query, "f")[m.method])) {
                tslib_1.__classPrivateFieldGet(this, _Contract_query, "f")[m.method] = createQuery(m, (f, o, p) => tslib_1.__classPrivateFieldGet(this, _Contract_read, "f").call(this, m, o, p).send(f));
            }
        });
    }
    get query() {
        return tslib_1.__classPrivateFieldGet(this, _Contract_query, "f");
    }
    get tx() {
        return tslib_1.__classPrivateFieldGet(this, _Contract_tx, "f");
    }
}
